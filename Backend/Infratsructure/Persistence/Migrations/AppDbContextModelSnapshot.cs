...
{
    /// <summary>
    /// Представляет актуальный снимок модели AppDbContext, с которым EF Core сравнивает будущие изменения сущностей и конфигураций.
    /// </summary>
    [DbContext(typeof(AppDbContext))]
    partial class AppDbContextModelSnapshot : ModelSnapshot
    {
        /// <summary>Восстанавливает актуальные метаданные таблиц, ограничений, индексов и связей.</summary>
